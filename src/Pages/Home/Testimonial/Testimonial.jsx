  ...
  return (
    <div className='testimonial'>
      <div className='wrapper'>
        <div className=' testimonial-bg-area lg:mt-[230px] xl:flex justify-between items-center'>
          <h3 className='testimonial-title lg:w-[651px]   lg:mt-[0px] text-[35px] md:text-[54px]'>
        ...
        <div className=' testimonial-content mt-[50px]  px-4 md:px-4 xl:px-0'>
          <div className='testimonial-img relative inline-block'>
            <img src={testimonial} alt='' />
            <img
              className='absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[88px]'
              src={play}
              alt=''
            />
          </div>
          <div className='testimonial-swiper mt-[90px]'>
            <div className='relative'>
              <div className='absolute right-[46px] -top-[80px]'>
                <svg
