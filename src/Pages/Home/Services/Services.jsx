...
const Services = () => {
  return (
    <div className='service-one pt-[90px] md:pt-[120px] ' id='services' >
        ...
        <div className='row'>
          ...
          <div className='service-cards lg:pl-[74px] lg:mt-0 relative '>
            <div className=' grid grid-cols-1 md:grid-cols-2 gap-[30px] '>
              ...
              <div className='service-card relative'>
                <img className='w-[73px] h-[71px]' src={icon2} alt='' />
                <h3 className='service-card-title'>Financial Analysis</h3>
                <p className='service-card-description'>
                  Business analysis is a professional discipline of identifying
                  business needs determining
                </p>
              ...
              <div className='service-card relative'>
                <img className='w-[73px] h-[71px]' src={icon3} alt='' />
                <h3 className='service-card-title'>Risk Management</h3>
                <p className='service-card-description'>
                  Business analysis is a professional discipline of identifying
                  business needs determining
                </p>
              ...
              <div className='service-card relative'>
                <img className='w-[73px] h-[71px]' src={icon4} alt='' />
